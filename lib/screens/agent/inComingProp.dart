...
import 'package:mdproject/screens/agent/datatable.dart';


class IncomingProperties extends StatefulWidget{
  @override 
  _IncomingPropterties createState() => _IncomingPropterties();
}

class _IncomingPropterties extends State<IncomingProperties> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: new AppBar(title: new Text('Incoming Properties'),backgroundColor: Colors.deepOrange,),
